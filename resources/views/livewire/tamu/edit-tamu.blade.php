...
<div class="md:container px-6 py-2 sm:px-3 mx-auto grid">
 ...
 <div
  ...
  <div class="flex items-center px-4">
   <span class="text-lg font-semibold">Edit Tamu</span>
  </div>
 </div>
 <div class="bottom-up">
  <div class="bg-gray-300 dark:bg-gray-800 overflow-hidden shadow-xl rounded-lg px-4 py-4">
   ...
   <div class="">
    <form wire:submit.prevent="update"
     class="max-w-md mx-auto bg-gray-200 dark:bg-gray-900 py-5 px-5 rounded-lg shadow-md">
     <div class="relative z-0 w-full mb-5 group">
      <label for="underline_select" class="sr-only">Underline select</label>
      <select wire:model="sapaan" id="underline_select"
       class="block text-gray-900 py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-400 appearance-none dark:text-white dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
     ...
     <div class="relative z-0 w-full mb-5 group">
      <input wire:model="nama" type="text" id="floating_name"
       class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-400 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-violet-500 focus:outline-none focus:ring-0 focus:border-violet-600 peer"
       placeholder=" " />
     ...
     <div class="relative z-0 w-full mb-5 group">
      <input wire:model="alamat" type="text" id="floating_alamat"
       class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-400 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-violet-500 focus:outline-none focus:ring-0 focus:border-violet-600 peer"
       placeholder=" " />
     ...
     <div class="flex justify-center">
      <button type="submit"
       class="w-1/2 md:w-2/3 text-white bg-violet-700 hover:bg-violet-800 focus:ring-4 focus:outline-none focus:ring-violet-300 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center dark:bg-violet-600 dark:hover:bg-violet-700 dark:focus:ring-violet-800">Update</button>
     </div>
    </form>
   </div>
