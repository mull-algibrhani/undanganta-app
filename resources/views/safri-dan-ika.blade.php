    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-8 text-center">
          ...
          <h3>Diselenggarakan pada 25 Agustus 2024 di Jl. Sungai Bialo 1, Kelurahan Mallilingi, Kec. Bantaeng. Kab. Bantaeng,
            Sulawesi Selatan</h3>
  ...
  <section id="gallery" class="gallery">
    <div class="container">
      ...
      <div class="row row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 justify-content-center">
        ...
        <div class="col mt-3">
          <a href="{{asset('wedding/img-safri/gallery/prawed-16.jpg')}}" data-toggle="lightbox" data-caption="Safri & Ika 16"
            data-gallery="mygallery">
            <img src="{{asset('wedding/img-safri/gallery/thumbnail/prawed-16.jpg')}}" alt="Safri & Ika 16"
              class="img-fluid w-100 rounded">
          </a>
        </div>
        <div class="col mt-3">
          <a href="{{asset('wedding/img-safri/gallery/prawed-17.jpg')}}" data-toggle="lightbox" data-caption="Safri & Ika 17"
            data-gallery="mygallery">
            <img src="{{asset('wedding/img-safri/gallery/thumbnail/prawed-17.jpg')}}" alt="Safri & Ika 17"
              class="img-fluid w-100 rounded">
          </a>
        </div>
      </div>
