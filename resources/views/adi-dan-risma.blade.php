...
<head>
  ...
  <meta property="og:url" content="https://undangan.online/dari-adi-saputra-dan-rismawati/kepada-yth-{{$item->slug}}" />
...
<body>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-8 col-10 text-center">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3971.0852291190295!2d119.73339727386744!3d-5.554383555183759!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zNcKwMzMnMTUuOCJTIDExOcKwNDQnMDkuNSJF!5e0!3m2!1sid!2sid!4v1719651113394!5m2!1sid!2sid" width="100%" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  ...
  <section id="gallery" class="gallery">
    <div class="container">
      ...
      <div class="row row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 justify-content-center">
        <div class="col mt-3">
          <a href="{{asset('wedding/img/gallery/prawed-4.jpeg')}}" data-toggle="lightbox" data-caption="Sandhika & Nofa 1" data-gallery="mygallery">
            <img src="{{asset('wedding/img/gallery/thumbnail/prawed-4.jpeg')}}" alt="Sandhika & Nofa 1" class="img-fluid w-100 rounded">
          </a>
        </div>
        <div class="col mt-3">
          <a href="{{asset('wedding/img/gallery/prawed-1.jpeg')}}" data-toggle="lightbox" data-caption="Sandhika & Nofa 2" data-gallery="mygallery">
            <img src="{{asset('wedding/img/gallery/thumbnail/prawed-1.jpeg')}}" alt="Sandhika & Nofa 2" class="img-fluid w-100 rounded">
          </a>
        </div>
        <div class="col mt-3">
          <a href="{{asset('wedding/img/gallery/prawed-3.jpeg')}}" data-toggle="lightbox" data-caption="Sandhika & Nofa 3" data-gallery="mygallery">
            <img src="{{asset('wedding/img/gallery/thumbnail/prawed-3.jpeg')}}" alt="Sandhika & Nofa 3" class="img-fluid w-100 rounded">
          </a>
        </div>
        <div class="col mt-3">
          <a href="{{asset('wedding/img/gallery/prawed-2.jpeg')}}" data-toggle="lightbox" data-caption="Sandhika & Nofa 4" data-gallery="mygallery">
            <img src="{{asset('wedding/img/gallery/thumbnail/prawed-2.jpeg')}}" alt="Sandhika & Nofa 4" class="img-fluid w-100 rounded">
          </a>
        </div>
        <div class="col mt-3">
          <a href="{{asset('wedding/img/gallery/prawed-5.jpeg')}}" data-toggle="lightbox" data-caption="Sandhika & Nofa 5" data-gallery="mygallery">
            <img src="{{asset('wedding/img/gallery/thumbnail/prawed-5.jpeg')}}" alt="Sandhika & Nofa 5" class="img-fluid w-100 rounded">
          </a>
        </div>
        <div class="col mt-3">
          <a href="{{asset('wedding/img/gallery/prawed-6.jpeg')}}" data-toggle="lightbox" data-caption="Sandhika & Nofa 6" data-gallery="mygallery">
            <img src="{{asset('wedding/img/gallery/thumbnail/prawed-6.jpeg')}}" alt="Sandhika & Nofa 6" class="img-fluid w-100 rounded">
          </a>
        </div>
        <div class="col mt-3">
          <a href="{{asset('wedding/img/gallery/prawed-7.jpeg')}}" data-toggle="lightbox" data-caption="Sandhika & Nofa 6" data-gallery="mygallery">
            <img src="{{asset('wedding/img/gallery/thumbnail/prawed-7.jpeg')}}" alt="Sandhika & Nofa 6" class="img-fluid w-100 rounded">
          </a>
        </div>
        <div class="col mt-3">
          <a href="{{asset('wedding/img/gallery/prawed-8.jpeg')}}" data-toggle="lightbox" data-caption="Sandhika & Nofa 6" data-gallery="mygallery">
            <img src="{{asset('wedding/img/gallery/thumbnail/prawed-8.jpeg')}}" alt="Sandhika & Nofa 6" class="img-fluid w-100 rounded">
          </a>
        </div>
      </div>
    </div>
  ...
  <section id="rsvp" class="rsvp">
    <div class="container">
      ...
      <form id="my-form" action="{{ route('submit-rsvp') }}" method="POST" class="row row-cols-md-auto g-3 align-items-center justify-content-center">
        @csrf
        <div class="col-12">
          <div class="mb-3">
