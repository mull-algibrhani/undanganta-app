<div class=" text-gray-500 dark:text-gray-400">
 ...
 <div class=" rounded-lg dark:bg-gray-800 mr-2 bg-gray-50">
  ...
  <ul>
   <li class="relative px-6 py-3">
    <span id="project"
     class="{{ request()->is('daftar-tamu') || request()->is('new-project') || request()->is('project/edit/*') ? '' : 'hidden' }} absolute inset-y-0 left-3 w-1 bg-violet-600 rounded-tr-lg rounded-br-lg"
     aria-hidden="true"></span>
    <a
